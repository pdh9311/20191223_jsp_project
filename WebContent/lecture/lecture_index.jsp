...
<div class="lectureWrap">
	<div class="lectureLine">
		<form action="lecture_index_db.lr" method="post"
			enctype="multipart/form-data" id="lecture_info">
			<input type="hidden" id="lecture_name" name="lecture_name" value="${param.lecture_name}"> 
			...
			<table>
				...
				<tr>
					<td colspan="2"><input id="add" class="btn btn-primary"
						type="button" value="다음 강의 추가"> <input id="finish"
						class="btn btn-primary" type="button" value="끝내기"></td>
				</tr>
			</table>
		</form>
	</div>
